...
async def control_device(
    ...
    Examples:
        - Turn on living room lights: control_device("on", room="living_room", device_type="light")
...
def format_device_status(device: dict) -> str:
    ...
    if device["type"] == "light" and "brightness" in props:
        ...
        details.append(f"Target: {props.get('target_temp')}°F, Current: {props.get('current_temp')}°F")
